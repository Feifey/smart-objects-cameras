...
**One-line pitch:** By using the sound detection and visual generator, this is a forest created by facilitator and student's voices. 
...
I wanted the room to show how hard the facilitator and the students having talk and discussion, using visualized material to indicate the process of the classroom. Also, it could be a relaxing process when the students see the forest grow with them.
